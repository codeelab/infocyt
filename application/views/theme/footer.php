    ...
    <![endif]-->
        ...
        <script src="<?=base_url();?>assets/js/reveal-animate.js" type="text/javascript"></script>
        <!-- END: CORE PLUGINS -->
        <!-- BEGIN: LAYOUT PLUGINS -->
        <script src="<?=base_url();?>assets/js/jquery.themepunch.tools.min.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/jquery.themepunch.revolution.min.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/revolution.extension.slideanims.min.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/revolution.extension.layeranimation.min.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/revolution.extension.navigation.min.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/revolution.extension.video.min.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/revolution.extension.parallax.min.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/jquery.cubeportfolio.min.js" type="text/javascript"></script>
        ...
        <script src="<?=base_url();?>assets/js/jquery.smooth-scroll.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/typed.min.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/bootstrap-slider.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/js.cookie.js" type="text/javascript"></script>
        <!-- END: LAYOUT PLUGINS -->
        <!-- BEGIN: THEME SCRIPTS -->
        ...
        <!-- END: THEME SCRIPTS -->
        <!-- BEGIN: PAGE SCRIPTS -->
        <script src="<?=base_url();?>assets/js/slider-4.js" type="text/javascript"></script>
        ...
        <script src="<?=base_url();?>assets/js/packery-mode.pkgd.min.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/jquery.requestAnimationFrame.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/jquery.mousewheel.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/ilightbox.packed.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/isotope-gallery.js" type="text/javascript"></script>
        <script src="<?=base_url();?>assets/js/revolution.extension.parallaax.min.js" type="text/javascript"></script>
        <!-- END: PAGE SCRIPTS -->
