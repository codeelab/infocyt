...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Instituto de Ciencia, Tecnología e Innovación del Estado de Michoacán</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1.0" name="viewport" />
        <meta http-equiv="Content-type" content="text/html; charset=utf-8">
        <meta name="description" content="Instituto de Ciencia, Tecnología e Innovación del Estado de Michoacán">
        ...
        <link rel="apple-touch-icon" sizes="120x120" href="<?=base_url()?>assets/images/Icon-60@2x.png">
        <link rel="apple-touch-icon" sizes="152x152" href="<?=base_url()?>assets/images/Icon-76@2x.png">
