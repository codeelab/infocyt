...
ob_start();
        ...
        {  
                ...
                { 
                        ...
                        $titulo = $v->titulo_reporte;
                        $cyt_nombre_entidad = $v->nombre_entidad;
                        $descripcion_general = $v->descr_general;
                        $fecha_entrega = $v->fecha_reporte;
                        $t_autor = $v->nombre_tipo;
                        $autor = $v->autor;
                        $total_autor = $v->total_autores;
                        $descr_larga = $v->descipcion_larga;

                }
        }

            $transf = strtotime($fecha_entrega);
        ...
        $w = array(80, 130);
        $al = array('L', 'L');
        $titulos = array("TITULO","NOMBRE DE LA ENTIDAD","DESCRIPCIÓN GENERAL","FECHA DE ENTREGA","TIPO DE AUTOR","NOMBRE DEL AUTOR","TOTAL DE AUTORES","DESCRIPCIÓN LARGA");
        $datos = array($titulo, $cyt_nombre_entidad, $descripcion_general,$fecha,$t_autor, $autor, $total_autor,$descr_larga);
        $fill = 0;
        ...
        $pdf->Cell(0, 7, "FICHA DE REPORTE TÉCNICO", 'B', 0, 'R', 1);
        $pdf->Ln();
