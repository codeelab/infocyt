...
ob_start();
        ...
        {  
                ...
                { 
                        ...
                        $ps_cyt_isector = $v->descr_sector;
                        $ps_cyt_institucion_id = $v->institucion_resp;
                        $ps_cyt_dependencia_id = $v->descr_dependencia;
                        $ps_cyt_departamento_id = $v->descr_sector;
                        ...
                        $concluida = $v->conclusion;
                        $cyt_tit_tesis = $v->titulo_tesis;
                }
        }
        ...
        $w = array(80, 130);
        $al = array('L', 'L');
        $titulos = array("AUTOR","FECHA DE INICIO","GRADO DE TESIS", "FECHA DE FINALIZACIÓN","PAIS","TIPO DE ENTIDAD ASESORA","SECTOR DE ENTIDAD ASESORA","INSTITUCIÓN EMPLEADORA","DEPENDENCIA","DEPARTAMENTO","CAMPO DE FINANCIAMIENTO","DISCIPLINA","SUBDISCIPLINA","TERMINADA","TITULO DE TESIS DIRIGIDA");
        $datos = array($autor, $fecha,$grado, $final,$pais, $t_entidad,$ps_cyt_isector,$ps_cyt_institucion_id,$ps_cyt_dependencia_id,$ps_cyt_departamento_id,$ps_cyt_campo_id,$ps_cyt_disciplina_id,$ps_cyt_subdisciplina_id,$concluida,$cyt_tit_tesis);
        $fill = 0;
        // create new PDF document
        $pdf = new TCPDF('P', 'mm', 'A4', true, 'UTF-8', false);
        $pdf->SetTitle($folio.'-Tesis-'.$numero.'.pdf');
        ...
        $pdf->Cell(0, 7, "FICHA DE TESIS", 'B', 0, 'R', 1);
        $pdf->Ln();
        ...
        $pdf->Output($folio.'-Tesis-'.$numero.'.pdf');
        unset($pdf)
