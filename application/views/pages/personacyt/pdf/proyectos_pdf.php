...
ob_start();
        ...
        {  
                ...
                { 
                        ...
                        $numero = $v->id_proyectos;
                        $folio = $v->id_usuario;

                        $nombre = $v->nombre_proyecto;
                        $qpcyt_tipo_proyecto_id = $v->nombre_tipo_proyecto;
                        $qpcyt_entidad_id = $v->nom_empleador;
                        $ps_cyt_isector_id = $v->descr_sector;
                        $institucion = $v->institucion;
                        $dependencia = $v->descr_dependencia;
                        $departamento = $v->descr_departamentos;
        ...
        $w = array(80, 130);
        $al = array('L', 'L');
        $titulos = array("TITULO","TIPO DE PROYECTO","TIPO DE ENTIDAD APOYANDO","INSTITUCIÓN RESPALDANTE","SECTOR DE LA INSTITUCIÓN","DEPENDENCIA DE LA INSTITUCIÓN","DEPARTAMENTO","FECHA DE INICIO","FECHA DE FINALIZACIÓN","FINALIDAD DEL PROYECTO","CAMPO DE CONOCIMIENTO","DISCIPLINA DE CONOCIMIENTO","SUBDISCIPLINA","SECTOR ECONÓMICO","RAMA ECONÓMICA","CLASE ECONÓMICA","DESCRIPCIÓN DEL PROYECTO");
        $datos = array($nombre, $qpcyt_tipo_proyecto_id,$qpcyt_entidad_id,$institucion,$ps_cyt_isector_id,$dependencia,$departamento,$fecha,$final,$finalidad,$ps_cyt_campo_id,$ps_cyt_disciplina_id,$ps_cyt_subdisciplina_id,$ps_cyt_sector_id,$ps_cyt_rama_id,$ps_cyt_clase_id,$descripcion_larga);
        $fill = 0;
        // create new PDF document
        $pdf = new TCPDF('P', 'mm', 'A4', true, 'UTF-8', false);
        $pdf->SetTitle($folio.'-Proyecto_Investigacion-'.$numero.'.pdf');
        ...
        $pdf->Cell(0, 7, "FICHA DE PROYECTOS DE INVESTIGACIÓN", 'B', 0, 'R', 1);
        $pdf->Ln();
        ...
        $pdf->Output($folio.'-Proyecto_Investigacion-'.$numero.'.pdf');
        unset($pdf)
