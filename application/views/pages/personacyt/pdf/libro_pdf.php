...
ob_start();
        ...
        {  
                ...
                { 
                        ...
                        $cyt_isbn = $v->isbn;
                        $titulo = $v->titulo_libro;
                        $anio_publicacion = $v->fecha_pub;
                        $tipol_ibro = $v->nombre_libro;
        ...
        $w = array(80, 130);
        $al = array('L', 'L');
        $titulos = array("ISBN","TITULO","AÑO DE PUBLICACIÓN","TIPO DE LIBRO","TIPO DE AUTOR","NOMBRE DEL AUTOR","TOTAL DE AUTORES","PAÍS","VOLÚMEN DEL LIBRO","NÚMERO DE PÁGINAS","EDITORES","EDITORIAL","CAMPO DE CONOCIMIENTO","DISCIPLINA DE CONOCIMIENTO","SUBDISCIPLINA","IDIOMA DEL LIBRO","DESCRIPCIÓN LARGA");
        $datos = array($cyt_isbn,$titulo, $fecha, $tipol_ibro,$t_autor, $autor, $total_autor,$pais,$cyt_volumen, $paginas,$cyt_editores, $cyt_editorial, $ps_cyt_campo_id,$ps_cyt_disciplina_id, $ps_cyt_subdisciplina_id, $idioma,$descr_larga);
        $fill = 0;
        ...
        $pdf->Cell(0, 7, "FICHA DE LIBROS", 'B', 0, 'R', 1);
        $pdf->Ln();
