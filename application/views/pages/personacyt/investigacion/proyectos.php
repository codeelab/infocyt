                     ...
                     <div class="c-contact">
                        ...
                        <div style="margin: 15px;">
                            ...
                            <table class="table display responsive no-wrap" width="100%" id="tablePersonacyt">
                                 <thead>
                             <tr>
                                <th><i class='fas fa-bookmark' aria-hidden='true'></i> PROYECTO</th>
                            ...
                            foreach ($proyectos as $t) 
                            {
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td class="center"><a href="'.base_url('proyectos_pdf/').$t->id_proyectos.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$t->nombre_proyecto.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
                    ...
                    <div class="row">  
                        ...
                        <div class="col-md-4">
                            <label class="form-text" for="otorgante">DEPARTAMENTO DEPENDENCIA:</label>
                                <?php echo form_dropdown('departamento_id', $departamento, ' ', 'class="form-control c-theme c-square input-lg" id="departamento_id"');?>
                        </div>  
                    </div>  
                    <br>
                    <div class="row">    
