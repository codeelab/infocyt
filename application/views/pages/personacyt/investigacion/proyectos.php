...
<div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold">
    <div class="container">
        ...
        <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
            <li><a href="<?=base_url('personacyt');?>">Inicio</a></li> | <li><a href="<?=base_url('personacyt/proyectos');?>" class="c-font-dark">Proyectos</a></li>
        </ul>
    </div>
</div>
                ...
                <div class="c-content-media-2-slider wow  fadeInRight animated" data-slider="owl" style="visibility: visible; animation-name: fadeInRight; opacity: 1;">
                     ...
                     <div class="c-contact">
                        <div class="c-content-title-1">
                            <h3 class="c-font-uppercase c-font-bold">Listado de Proyectos</h3>
                        </div>                
                        <div style="margin: 15px;">
                            ...
                            <table class="table display responsive no-wrap" width="100%" id="tablePersonacyt">
                                 <thead>
                             <tr>
                                <th><i class='fas fa-list-ul' aria-hidden='true'></i> PROYECTO</th>
                                <th><i class='fas fa-list-ul' aria-hidden='true'></i> TÍTULO</th>
                    ...
                    <?php
                        ...
                        if($proyectos !== FALSE) 
                        {
                            foreach ($proyectos as $t) 
                            {
                                ...
                                echo '
                                    <tr>
                                        <td>'.$t->nombre_tipo_proyecto.'</td>
                                        <td>'.$t->nombre_proyecto.'</td>
                                        <td class="center"><a href="'.base_url('pdf/').$t->id_proyectos.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$t->nombre_proyecto.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php $atrib = array('id' => 'registro', 'autocomplete'=> 'off');
                            echo form_open('personacyt/alta_proyectos', $atrib); ?>
                    <div class="row">
                        <div class="col-md-3">
                            <label class="form-text" for="otorgante">INICIO:</label>
                        ...
                        <div class="col-md-3">
                            <label class="form-text" for="otorgante">FIN:</label>
                        ...
                        <div class="col-md-3">
                            <label class="form-text" for="otorgante">PROYECTO:</label>
                            <?php echo form_dropdown('tipo_proyecto_id', $proyecto, ' ', 'class="form-control c-theme c-square input-lg" id="tipo_proyecto_id"');?>
                        </div> 
                        <div class="col-md-3">
                            <label class="form-text" for="pais">ENTIDAD:</label>
                                <?php
                    ...
                    <div class="row"> 
                         <div class="col-md-12">
                            <label class="form-text" for="otorgante">TÍTULO DEL PROYECTO:</label>
                           <input type="text" class="form-control c-theme c-square input-lg" id="nombre_proyecto" name="nombre_proyecto" placeholder="TÍTULO">
                        </div>
                    </div>
                    <br>
                    <div class="row"> 
                         <div class="col-md-12">
                            <label class="form-text" for="otorgante">INSTITUCIÓN RESPALDANTE:</label>
                           <input type="text" class="form-control c-theme c-square input-lg" id="institucion" name="institucion" placeholder="TÍTULO">
                        </div>
                    </div>
                    <br>
                    <div class="row">  
                        <div class="col-md-4">
                            <label class="form-text" for="otorgante">SECTOR DE LA INSTITUCIÓN:</label>
                                <?php
                        ...
                        <div class="col-md-4">
                            <label class="form-text" for="otorgante">DEPENDENCIA INSTITUCIÓN:</label>
                                <?php echo form_dropdown('dependencia_id', $dependencia, ' ', 'class="form-control c-theme c-square input-lg" id="dependencia_id"');?>
                        </div>     
                        <div class="col-md-4">
                            <label class="form-text" for="otorgante">DEPARTAMENTO DEPENDENCIA:</label>
                                <?php echo form_dropdown('departamento_id', array(), null, "id='departamento_id' class='form-control c-theme c-square input-lg'"); ?>
                        </div>  
                    </div>  
                    <br>
                    <div class="row">    
                        <div class="col-md-12">
                            <label class="form-text" for="otorgante">FINALIDAD DEL PROYECTO:</label>
                            <textarea rows="4" maxlength="250" class="form-control c-theme c-square input-lg" id="finalidad" name="finalidad" style="text-transform: uppercase;"/></textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="row">    
                        <div class="col-md-12">
                            <label class="form-text" for="otorgante">DESCRIPCIÓN DEL PROYECTO:</label>
                            <textarea rows="4" maxlength="250" class="form-control c-theme c-square input-lg" id="descripcion_larga" name="descripcion_larga" style="text-transform: uppercase;"/></textarea>
                        </div>
                    </div>
                    <br>
                      <div class="row">
