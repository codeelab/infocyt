...
<div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold">
    <div class="container">
        ...
        <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
            <li><a href="<?=base_url('personacyt');?>">Inicio</a></li> | <li><a href="<?=base_url('personacyt/academica');?>" class="c-font-dark">Academica</a></li>
        </ul>
    </div>
</div>
                            ...
                            foreach ($grados as $g) 
                            {
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td>'.$g->num_cedula.'</td>
                                        <td class="center"><a href="'.base_url('academica_pdf/').$g->id_academica.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$g->num_cedula.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
                ...
                <?php $atrib = array('id' => 'registro_personacyt', 'autocomplete'=> 'off');
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control c-theme c-square input-lg" id="fecha_terminacion" name="fecha_terminacion" placeholder="YYYY/MM/DD"/>
                        </div>  
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label class="form-text" for="otorgante">SECTOR INSTITUCIÓN:</label>
                                <?php
                    ...
                    <div class="row">    
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control c-theme c-square input-lg" id="departamento" name="departamento" placeholder="Dependencia a la que pertenece de la institución">
                        </div>
                    </div> 
                    <div class="row">    
                        <div class="col-md-12">
                            <label class="form-text" for="otorgante">DEPARTAMENTO DE LA DEPENDENCIA:</label>
                            <input type="text" class="form-control c-theme c-square input-lg" id="dependencia" name="dependencia" placeholder="Departamento o área asignada de la dependencia">
                        </div>  
                    </div>  
                    <br>
                    <div class="row">    
