                            ...
                            foreach ($investigaciones as $i) 
                            {
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td class="center"><a href="'.base_url('investigacion_pdf/').$i->id_investigacion.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$i->id_investigacion.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
                     ...
                     <div class="row">
                        <div class="col-md-12">
                            <label class="form-text" for="otorgante">NOMBRE DE LA ENTIDAD:</label>
                               <input type="text" class="form-control c-theme c-square input-lg" id="institucion_empleadora" name="institucion_empleadora" placeholder="Institución Otorgante del Grado Acádemico">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <label class="form-text" for="otorgante">INSTITUCIÓN DE LA ENTIDAD EMPLEADORA:</label>
                                <input type="text" class="form-control c-theme c-square input-lg" id="nombre_ent" name="institucion_empleadora" placeholder="Institución Otorgante del Grado Acádemico">
                        </div>       
                    </div>
                    <br> 
                    <div class="row">    
