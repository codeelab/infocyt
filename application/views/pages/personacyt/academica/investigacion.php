...
<div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold">
    <div class="container">
        ...
        <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
            <li><a href="<?=base_url('personacyt');?>">Inicio</a></li> | <li><a href="<?=base_url('personacyt/academica');?>" class="c-font-dark">Estancias de Investigación</a></li>
        </ul>
    </div>
</div>
                ...
                <div class="c-content-media-2-slider wow  fadeInRight animated" data-slider="owl" style="visibility: visible; animation-name: fadeInRight; opacity: 1;">
                     ...
                     <div class="c-contact">
                        <div class="c-content-title-1">
                            <h3 class="c-font-uppercase c-font-bold">Listado de Estancias de Investigación</h3>
                        </div>                
                        <div style="margin: 15px;">
                            <button class="btn btn-sm c-btn-purple c-btn-square c-btn-border-2x" data-toggle="modal" data-target="#mascongreso">
                                <i class="fas fa-check-circle"></i> Agregar Estancia
                            </button>
                            ...
                            <table class="table display responsive no-wrap" width="100%" id="tablePersonacyt">
                             ...
                             <tr>
                                ...
                                <th><i class='fas fa-id-card' aria-hidden='true'></i>  DEPENDENCIA</th>
                    ...
                    <?php
                        ...
                        if($investigaciones !== FALSE) 
                        {
                            foreach ($investigaciones as $i) 
                            {
                                ...
                                echo '
                                    <tr>
                                        <td>'.$i->fecha_inicio.' - '.$i->fecha_fin.'</td>
                                        <td>'.$i->nom_empleador.'</td>
                                        <td>'.$i->descr_sector.'</td>
                                        <td>'.$i->descr_dependencia.'</td>
                                        <td class="center"><a href="'.base_url('pdf/').$i->id_investigacion.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$i->id_investigacion.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php $atrib = array('id' => 'registro', 'autocomplete'=> 'off');
                            echo form_open('personacyt/alta_investigacion', $atrib); ?>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" min="1960" max="2025" step="1" class="form-control c-theme c-square input-lg" id="fecha_fin" name="fecha_fin" placeholder="2021"/>
                        </div>   
                        <div class="col-md-4">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                            <label class="form-text" for="otorgante">NOMBRE DE LA ENTIDAD:</label>
                               <input type="text" class="form-control c-theme c-square input-lg" id="nombre_ent" name="nombre_ent" placeholder="Institución Otorgante del Grado Acádemico">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <label class="form-text" for="descrp_grado">DESCRIPCIÓN DE LA ESTANCIA:</label>
                            <textarea rows="3" maxlength="150" class="form-control c-theme c-square input-lg" id="descrp_entidad" name="descrp_entidad" style="text-transform: uppercase;"/></textarea>
                        </div> 
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="row">    
                        <div class="col-md-12">
                            <label class="form-text" for="otorgante">DESCRIPCIÓN EXTENDIDA DE LA ESTANCIA:</label>
                               <textarea rows="4" maxlength="250" class="form-control c-theme c-square input-lg" id="descrp_estancia" name="descrp_estancia" style="text-transform: uppercase;"/></textarea>
                        </div>   
                    </div>
                    <br>
                  <div class="row">
