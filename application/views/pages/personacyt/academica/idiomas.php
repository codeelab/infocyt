                            ...
                            foreach ($idiomas as $i) 
                            {
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td class="center"><a href="'.base_url('idioma_pdf/').$i->id_idiomas.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$i->nombre_leng.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
                ...
                <?php $atrib = array('id' => 'registro_personacyt', 'autocomplete'=> 'off');
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control c-theme c-square input-lg" id="fecha_acreditacion" name="fecha_acreditacion" placeholder="YYYY/MM/DD"/>
                        </div>     
                        <div class="col-md-4">
