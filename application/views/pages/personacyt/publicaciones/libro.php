...
<div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold">
    <div class="container">
        ...
        <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
            <li><a href="<?=base_url('personacyt');?>">Inicio</a></li> | <li><a href="<?=base_url('personacyt/libro');?>" class="c-font-dark">Publicación de Libro</a></li>
        </ul>
    </div>
</div>
                ...
                <div class="c-content-media-2-slider wow  fadeInRight animated" data-slider="owl" style="visibility: visible; animation-name: fadeInRight; opacity: 1;">
                     ...
                     <div class="c-contact">
                        <div class="c-content-title-1">
                            <h3 class="c-font-uppercase c-font-bold">Listado de Publicación de Libro</h3>
                        </div>                
                            ...
                            foreach ($libro as $t) 
                            {
                                ...
                                echo '
                                    <tr>
                                        <td>'.$t->fecha_pub.'</td>
                                        <td>'.$t->autor.'</td>
                                        <td>'.$t->titulo_libro.'</td>
                                        <td class="center"><a href="'.base_url('pdf/').$t->id_libros.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$t->titulo_libro.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php $atrib = array('id' => 'registro', 'autocomplete'=> 'off');
                            echo form_open('personacyt/alta_libros', $atrib); ?>
                     <div class="row">
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">
                            <label class="form-text" for="otorgante">TIPO LIBRO:</label>
                            <?= form_dropdown('tipo_libro_id', $librox, ' ', 'class="form-control c-theme c-square input-lg" id="tipo_libro_id"'); ?>
                        </div>
                         <div class="col-md-4">
                    ...
                    <div class="row">  
                         <div class="col-md-4">
                            <label class="form-text" for="otorgante">ISBN:</label>
                           <input type="text" class="form-control c-theme c-square input-lg" id="isbn" name="isbn" placeholder="ISBN">
                        </div>  
                         <div class="col-md-8">
                            <label class="form-text" for="otorgante">TITULO:</label>
                           <input type="text" class="form-control c-theme c-square input-lg" id="titulo_libro" name="titulo_libro" placeholder="TÍTULO">
                        </div>
                    </div>
                    <br>
                    <div class="row">  
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control c-theme c-square input-lg" id="total_autor" name="total_autor" placeholder="NUMERO"/>
                        </div> 
                         <div class="col-md-9">
                            <label class="form-text" for="otorgante">AUTOR:</label>
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <label class="form-text" for="otorgante">PÁGINAS:</label>
                        ...
                        <div class="col-md-3">
                         ...
                         <div class="col-md-3">
                            <label class="form-text" for="otorgante">IDIOMA:</label>
                            <?php
