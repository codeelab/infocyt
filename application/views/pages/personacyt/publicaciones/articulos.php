...
<div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold">
    <div class="container">
        ...
        <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
            <li><a href="<?=base_url('personacyt');?>">Inicio</a></li> | <li><a href="<?=base_url('personacyt/libro');?>" class="c-font-dark">Capítulo de Libro</a></li>
        </ul>
    </div>
</div>
                ...
                <div class="c-content-media-2-slider wow  fadeInRight animated" data-slider="owl" style="visibility: visible; animation-name: fadeInRight; opacity: 1;">
                     ...
                     <div class="c-contact">
                        <div class="c-content-title-1">
                            <h3 class="c-font-uppercase c-font-bold">Listado de Publicación de Artículos</h3>
                        </div>                
                        <div style="margin: 15px;">
                            ...
                            <table class="table display responsive no-wrap" width="100%" id="tablePersonacyt">
                             ...
                             <tr>
                                ...
                                <th><i class='fas fa-list-ul' aria-hidden='true'></i> ESTATUS</th>
                            ...
                            foreach ($articulos as $t) 
                            {
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td>'.$t->titulo_articulo.'</td>
                                        <td class="center"><a href="'.base_url('pdf/').$t->id_articulos.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$t->titulo_articulo.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php $atrib = array('id' => 'registro', 'autocomplete'=> 'off');
                            echo form_open('personacyt/alta_articulos', $atrib); ?>
                     <div class="row">
                        <div class="col-md-4">
                         ...
                         <div class="col-md-8">
                           ...
                           <input type="text" class="form-control c-theme c-square input-lg" id="titulo_articulo" name="titulo_articulo" placeholder="TÍTULO DEL ARTÍCULO">
                        </div>
                    </div>
                    <br>
                    <div class="row">    
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <label class="form-text" for="pais">ESTATUS:</label>
                                <?= form_dropdown('estatus_articulo_id', $estatus, ' ', 'class="form-control c-theme c-square input-lg" id="estatus_articulo_id"'); ?>
                        </div> 
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <label class="form-text" for="otorgante">VOLUMEN:</label>
                            <input type="number" class="form-control c-theme c-square input-lg" id="num_volumen" name="num_volumen" placeholder="NÚMERO"/>
                        </div> 
                    </div>
                    <br>
                    <div class="row">    
                        <div class="col-md-12">
                            ...
                            <textarea rows="3" maxlength="250" class="form-control c-theme c-square input-lg" id="coautor" name="coautor" style="text-transform: uppercase;"/></textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">    
                        <div class="col-md-12">
                            <label class="form-text" for="otorgante">REVISTA:</label>
                           <textarea rows="3" maxlength="250" class="form-control c-theme c-square input-lg" id="rev_publicacion" name="rev_publicacion" style="text-transform: uppercase;"/></textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
