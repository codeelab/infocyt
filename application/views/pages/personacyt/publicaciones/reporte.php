                     ...
                     <div class="c-contact">
                        ...
                        <div style="margin: 15px;">
                            ...
                            <table class="table display responsive no-wrap" width="100%" id="tablePersonacyt">
                                 <thead>
                             <tr>
                                <th><i class='fas fa-briefcase' aria-hidden='true'></i> ENTIDAD</th>
                            ...
                            foreach ($reporte as $t) 
                            {
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td class="center"><a href="'.base_url('reporte_pdf/').$t->id_reporte.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$t->titulo_reporte.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
                ...
                <?php $atrib = array('id' => 'registro_personacyt', 'autocomplete'=> 'off');
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control c-theme c-square input-lg" id="fecha_reporte" name="fecha_reporte" placeholder="YYYY/MM/DD"/>
                        </div>
                        <div class="col-md-3">
