...
<div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold">
    <div class="container">
        ...
        <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
            <li><a href="<?=base_url('personacyt');?>">Inicio</a></li> | <li><a href="<?=base_url('personacyt/reporte');?>" class="c-font-dark">Reporte Técnico</a></li>
        </ul>
    </div>
</div>
                ...
                <div class="c-content-media-2-slider wow  fadeInRight animated" data-slider="owl" style="visibility: visible; animation-name: fadeInRight; opacity: 1;">
                     ...
                     <div class="c-contact">
                        <div class="c-content-title-1">
                            <h3 class="c-font-uppercase c-font-bold">Listado de Reporte Técnico</h3>
                        </div>                
                        <div style="margin: 15px;">
                            <button class="btn btn-sm c-btn-purple c-btn-square c-btn-border-2x" data-toggle="modal" data-target="#mascongreso">
                                <i class="fas fa-check-circle"></i> Agregar reporte
                            </button>
                    ...
                    <?php
                        ...
                        if($reporte !== FALSE) 
                        {
                            foreach ($reporte as $t) 
                            {
                                ...
                                echo '
                                    <tr>
                                        <td>'.$t->fecha_reporte.'</td>
                                        <td>'.$t->autor.'</td>
                                        <td>'.$t->titulo_reporte.'</td>
                                        <td class="center"><a href="'.base_url('pdf/').$t->id_reporte.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$t->titulo_reporte.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php $atrib = array('id' => 'registro', 'autocomplete'=> 'off');
                            echo form_open('personacyt/alta_reportes', $atrib); ?>
                    <div class="row">  
                         <div class="col-md-12">
                            <label class="form-text" for="otorgante">TITULO:</label>
                           <input type="text" class="form-control c-theme c-square input-lg" id="titulo_reporte" name="titulo_reporte" placeholder="TÍTULO DE REPORTE TÉCNICO">
                        </div>
                    </div>
                    <br>
                    <div class="row">  
                    ...
                    <div class="row">    
                        <div class="col-md-12">
                            ...
                            <textarea rows="3" maxlength="250" class="form-control c-theme c-square input-lg" id="descr_general" name="descr_general" style="text-transform: uppercase;"/></textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" min="1960" max="2025" step="1" class="form-control c-theme c-square input-lg" id="fecha_reporte" name="fecha_reporte" placeholder="2021"/>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">    
                        <div class="col-md-12">
                            ...
                            <textarea rows="3" maxlength="250" class="form-control c-theme c-square input-lg" id="descipcion_larga" name="descipcion_larga" style="text-transform: uppercase;"/></textarea>
                        </div>
                    </div>
                    <br>
                      <div class="row">
