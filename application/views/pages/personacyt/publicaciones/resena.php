...
<div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold">
    <div class="container">
        ...
        <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
            <li><a href="<?=base_url('personacyt');?>">Inicio</a></li> | <li><a href="<?=base_url('personacyt/resena');?>" class="c-font-dark">Reseñas</a></li>
        </ul>
    </div>
</div>
                        ...
                        <div style="margin: 15px;">
                            ...
                            <table class="table display responsive no-wrap" width="100%" id="tablePersonacyt">
                             ...
                             <tr>
                                ...
                                <th><i class='fas fa-list-ul' aria-hidden='true'></i> PUBLICACIÓN</th>
                        ...
                        if($resena !== FALSE) 
                        {
                            foreach ($resena as $t) 
                            {
                                ...
                                echo '
                                    <tr>
                                        <td>'.$t->fecha_pub.'</td>
                                        <td>'.$t->nombre_publicacion.'</td>
                                        <td>'.$t->titulo.'</td>
                                        <td class="center"><a href="'.base_url('pdf/').$t->id_resena.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$t->titulo.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php $atrib = array('id' => 'registro', 'autocomplete'=> 'off');
                            echo form_open('personacyt/alta_resenas', $atrib); ?>
                    <div class="row">  
                         <div class="col-md-12">
                            <label class="form-text" for="otorgante">TITULO:</label>
                           <input type="text" class="form-control c-theme c-square input-lg" id="titulo" name="titulo" placeholder="TÍTULO DE REPORTE TÉCNICO">
                        </div>
                    </div>
                    <br>
                    <div class="row"> 
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <label class="form-text" for="otorgante">TIPO AUTOR:</label>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" min="1960" max="2025" step="1" class="form-control c-theme c-square input-lg" id="fecha_pub" name="fecha_pub" placeholder="2021"/>
                        </div>
                        <div class="col-md-3">
                            <label class="form-text" for="otorgante">TIPO:</label>
                            <?= form_dropdown('tipo_publicacion_id', $publicacion, ' ', 'class="form-control c-theme c-square input-lg" id="tipo_publicacion_id"'); ?>
                        </div> 
                        <div class="col-md-3">
                            <label class="form-text" for="otorgante">AUTORES:</label>
                            <input type="number" class="form-control c-theme c-square input-lg" id="total_autores" name="total_autores" placeholder="50"/>
                        </div>  
                    </div>
                    <br>
                    <div class="row">    
                        <div class="col-md-12">
                            ...
                            <textarea rows="3" maxlength="250" class="form-control c-theme c-square input-lg" id="  comentarios" name=" comentarios" style="text-transform: uppercase;"/></textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label class="form-text" for="otorgante">PAG. INICIAL:</label>
                            <input type="number" class="form-control c-theme c-square input-lg" id="pag_inicial" name="pag_inicial" placeholder="50"/>
                        </div>
                        <div class="col-md-3">
                            <label class="form-text" for="otorgante">PAG. FINAL:</label>
                            <input type="number" class="form-control c-theme c-square input-lg" id="pag_final" name="pag_final" placeholder="50"/>
                        </div>  
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="row">    
                        <div class="col-md-12">
                            ...
                            <textarea rows="3" maxlength="250" class="form-control c-theme c-square input-lg" id="descripcion_larga" name="descripcion_larga" style="text-transform: uppercase;"/></textarea>
                        </div>
                    </div>
                    <br>
                      <div class="row">
