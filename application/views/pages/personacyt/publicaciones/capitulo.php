                            ...
                            foreach ($capitulos as $t) 
                            {
                                ...
                                echo '
                                    <tr>
                                        <td>'.$t->fecha_pub.'</td>
                                        <td>'.$t->titulo.'</td>
                                        <td class="center"><a href="'.base_url('pdf/').$t->id_capitulos.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$t->id_capitulos.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
