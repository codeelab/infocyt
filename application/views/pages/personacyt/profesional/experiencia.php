                            ...
                            foreach ($experiencia as $t) 
                            {
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td>'.$t->nombre_dirigido.'</td>
                                        <td>'.$t->nombre_entidad.'</td>
                                        <td class="center"><a href="'.base_url('experiencia_pdf/').$t->id_experiencia.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$t->nombre_entidad.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
