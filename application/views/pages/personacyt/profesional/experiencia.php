...
<div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold">
    <div class="container">
        ...
        <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
            <li><a href="<?=base_url('personacyt');?>">Inicio</a></li> | <li><a href="<?=base_url('personacyt/experiencia');?>" class="c-font-dark">Experiencia profesional</a></li>
        </ul>
    </div>
</div>
            ...
            <div class="col-md-9">      
                <div class="c-content-media-2-slider wow  fadeInRight animated" data-slider="owl" style="visibility: visible; animation-name: fadeInRight; opacity: 1;">
                        ...
                        <div style="margin: 15px;">
                            ...
                            <table class="table display responsive no-wrap" width="100%" id="tablePersonacyt">
                             ...
                             <tr>
                                ...
                                <th><i class='fas fa-user' aria-hidden='true'></i> EMPLEADOR</th>
                    ...
                    <?php
                        ...
                        {
                            foreach ($experiencia as $t) 
                            {

                                echo '
                                    <tr>
                                        <td>'.$t->fecha_inicio.' - '.$t->fecha_final.'</td>
                                        <td>'.$t->nom_empleador.'</td>
                                        <td>'.$t->nombre_entidad.'</td>
                                        <td class="center"><a href="'.base_url('pdf/').$t->id_experiencia.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$t->nombre_entidad.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php $atrib = array('id' => 'registro', 'autocomplete'=> 'off');
                            echo form_open('personacyt/alta_experiencia', $atrib); ?>
                     <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <label class="form-text" for="otorgante">TIPO:</label>
                                <?= form_dropdown('entidad_id', $dirigido, ' ', 'class="form-control c-theme c-square input-lg" id="entidad_id"'); ?>
                        </div> 
                        <div class="col-md-8">
                            <label class="form-text" for="pais">NOMBRE DE LA ENTIDAD:</label>
                                <input type="text" class="form-control c-theme c-square input-lg" id="nombre_entidad" name="nombre_entidad" placeholder="TÍTULO">
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row"> 
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control c-theme c-square input-lg" id="nom_puesto" name="nom_puesto" placeholder="Nombre del Autor o Autores">
                        </div> 
                    </div>
                    <br>
                     <div class="row">
                        <div class="col-md-12">
                            <label class="form-text" for="descrp_grado">EMPLEADOR(A):</label>
                            <input type="text" class="form-control c-theme c-square input-lg" id="empleador" name="empleador" placeholder="Nombre del Coautor o Coautores">
                        </div> 
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <label class="form-text" for="pais">INSTITUCIÓN RESPALDANTE:</label>
                    ...
                    <div class="row">    
                        <div class="col-md-12">
                            ...
                            <textarea rows="4" maxlength="500" class="form-control c-theme c-square input-lg" id="  descr_experiencia" name="   descr_experiencia" style="text-transform: uppercase;"/></textarea>
                        </div>
                    </div>
                    <br>  
                    <div class="row">    
