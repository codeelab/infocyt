                        ...
                        <div style="margin: 15px;">
                            ...
                            <table class="table display responsive no-wrap" width="100%" id="tablePersonacyt">
                             ...
                             <tr>
                                ...
                                <th><i class='fas fa-list-ul' aria-hidden='true'></i> GRADO</th>
                        ...
                        if($tesis !== FALSE) 
                        {
                            foreach ($tesis as $t) 
                            {
                                ...
                                echo '
                                    <tr>
                                        <td>'.$t->fecha_final.'</td>
                                        <td>'.$t->titulo_tesis.'</td>
                                        <td>'.$t->descr_grado.'</td>
                                        <td class="center"><a href="'.base_url('pdf/').$t->id_tesis.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$t->titulo_tesis.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
