                            ...
                            foreach ($tec as $t) 
                            {
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td>'.$t->nombre_area.'</td>
                                        <td class="center"><a href="'.base_url('desarrollos_pdf/').$t->id_desarrollos.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$t->nombre_autor.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
