                ...
                <div class="c-content-media-2-slider wow  fadeInRight animated" data-slider="owl" style="visibility: visible; animation-name: fadeInRight; opacity: 1;">
                     ...
                     <div class="c-contact">
                        <div class="c-content-title-1">
                            <h3 class="c-font-uppercase c-font-bold">Listado de Experiencia en Docencia</h3>
                        </div>                
                        <div style="margin: 15px;">
                            ...
                            <table class="table display responsive no-wrap" width="100%" id="tablePersonacyt">
                                 <thead>
                             <tr>
                                <th><i class='fas fa-briefcase' aria-hidden='true'></i> ASIGNATURA</th>
                                <th><i class='fas fa-graduation-cap' aria-hidden='true'></i> INSTITUCIÓN</th>
                            ...
                            foreach ($docencia as $t) 
                            {
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td class="center"><a href="'.base_url('docencia_pdf/').$t->id_docencia.'" target="_blank"><button type="button" class="btn btn-md c-btn-red c-btn-square c-btn-border-2x btn-block" data-toggle="tooltip" data-placement="bottom" title="'.$t->asignatura.'"><i class="far fa-file-pdf" aria-hidden="true"></i></button></a></td>
                                    </tr>
                                ';
                            }
                        }
